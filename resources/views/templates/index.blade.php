      ...
      <li class="nav-item @yield('tambah-pegawai')">
        ...
        <li class="nav-item @yield('tambah-frame')">
          <a class="nav-link" href="/admin/add-frame">
            ...
            <span>Tambah Data Motor</span></a>
          </li>

          <li class="nav-item @yield('stock-frame')">
            <a class="nav-link" href="/admin/add-frame">
              <i class="fas fa-glasses"></i>
              <span>Stock Motor</span></a>
            </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container">
          <div class="copyright text-center">
            <span>Copyright &copy; iisPOS by <a href="http://instagram.com/marfinohamzah455" target="_blank">IIS</a> {{date("Y")}}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
      ...
      <div class="modal-body">
        <div class="card" style="width: 28rem;">
          <div class="card-header">
            Detail Transaksi <b id="title_name" class="text-info">Motor</b>
            <br>
