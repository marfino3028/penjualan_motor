...
@section('title', 'Mutiara Motor - Add Employee')
    ...
    <div class="container-fluid">
      ...
      @endif
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Tambah Data Motor</h1>
        </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-6">
            ...
            <h4>Tambah Jenis Motor</h4>
            <hr>
          <form action="{{route('add-type')}}" method="POST" class="mb-5">
            @csrf
            <div class="form-group">
              <label for="id_brand">Merk Motor </label>
                  ...
                  <small>*Jika merk Motor tidak ada Tambahkan terlebih dahulu</small>
              </div>

              <div class="form-group">
                <label for="frame_type">Kode/Tipe Motor</label>
              ...
              <div class="form-group">
                <label for="stock">Stock Tipe Motor</label>
              ...
              <label for="price">Harga Tipe Motor</label>
              ...
              <div class="row justify-content-end">
                <button href="#" class="btn btn-success shadow-sm"><i class="fas fa-plus-circle"></i> Tambah Tipe Motor
                </button>
              </div>
          </form>
              </div>
        ...
        <form action="{{route('add-brand')}}" method="POST" class="mb-5">
          @csrf
            ...
            <div class="row justify-content-end">
              <button href="#" class="btn btn-success shadow-sm mr-2"><i class="fas fa-plus-circle"></i> Tambah Merk Motor
              </button>
            </div>
        </form>
