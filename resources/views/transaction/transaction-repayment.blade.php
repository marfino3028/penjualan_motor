...
@section('title', 'Mutiara Motor - Daftar Transaksi')
    ...
    <!-- Image and text -->
        ...
        <div class="container-fluid mt-5">
            ...
            <div class="row justify-content-start mb-4">
              <div class="col-12">
                <h1 class="display-5 mb-0 text-white"> <a href="/home" class="btn btn-lg btn-warning rounded-circle"><i class="fas fa-arrow-left"></i></a> Pelunasan Transaksi / Ambil Motor</h1>
              </div>
            </div>
                              ...
                              @csrf
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-6">
                                    <label for="inputJenisLensa">Jenis Motor</label>
                                    <input type="text" class="form-control" id="inputJenisLensa" readonly>
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label for="inputHargaLensa">Harga Motor</label>
                                    <div class="input-group">
                                ...
                                <button type="submit" name="btnSubmit" class="btn btn-danger">LUNAS / AMBIL Motor</button>
