...
@section('container')
    ...
    <div role="alert" aria-live="assertive" aria-atomic="true" class="toast mr-5" style="position: absolute; top: 25; right:0;z-index: 9999;" data-autohide="false">
      <div class="toast-header">
        ...
        <strong class="mr-auto">Mutiara Motor</strong>
                ...
                <div class="col-auto">
                    <div class="card text-center" style="width: 18rem;">
                        <div class="card-body">
                          ...
                          <p class="card-text">Pelunasan/Ambil Motor</p>
                ...
                <div class="col-auto">
                    <div class="card text-center" style="width: 18rem;">
                        <div class="card-body">
                          ...
                          <p class="card-text">Pendaftaran Pembeli Baru</p>
                          <a href="/patient/new-patient" class="btn btn-warning"><i class="fas fa-user-edit"></i> Daftar Pembeli Baru</a>
                        </div>
                      </div>
                </div>
                <div class="col-auto">
