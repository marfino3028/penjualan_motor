          ...
          <div class="col">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Daftar Pembeli Baru</h6>
              </div>
          ...
          <form action="{{route('add-patient')}}" method="POST" class="mb-5">
            @csrf
              <div class="form-group">
                ...
                <input type="nama_pasien" class="form-control @error('nama_pasien') is-invalid @enderror" placeholder="Nama Pembeli" name="nama_pasien" autocomplete="off" value={{old('nama_pasien')}} >
                @error('nama_pasien')
              ...
              <div class="row justify-content-end">
                <button type="submit" class="btn btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> Tambah Pembeli
                </button>
              </div>
          </form>
