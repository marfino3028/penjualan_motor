...
@section('title', 'Mutiara Motor Login');
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="{{url('img/login.png')}}" alt="" width="350" height="auto" class="mx-5 my-5">
              </div>
              <div class="col-lg-6 my-5">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h2 text-gray-bold mb-4">Selamat Datang Di Mutiara Motor</h1>
                    <br>
